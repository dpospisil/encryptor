 ...
 * -----------------------------------------------------------------------/
 */
package org.marvec.licenses.util;
...
public class EncryptionUtil {
    ...
    */
   private static final String PRIVATE_KEY_RESOURCE = "/org/marvec/licenses/private_key.pem";

   /**
    * String to hold name of the public key file.
    */
   private static final String PUBLIC_KEY_RESOURCE = "/org/marvec/licenses/public_key.pem";
   ...
   private PrivateKey getPemPrivateKey(final String resourceName) throws EncryptionException {
      try {
         final String temp = new String(Files.readAllBytes(Paths.get(getClass().getResource(resourceName).toURI())), DEFAULT_CHARSET);
      ...
      } catch (NoSuchAlgorithmException | URISyntaxException | InvalidKeySpecException | IOException e) {
